              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                    Ecza Kapımda olarak, Konya'da profesyonel kurye hizmeti veren
                    bir ekibiz. 2020 yılından bu yana, lisanslı eczanelerle işbirliği
                    halinde ilaç ihtiyaçlarınızı en hızlı ve güvenilir şekilde kapınıza
                    getiriyoruz.
                  </p>
              ...
              <div className="space-y-4">
                  ...
                  {openFAQ === 0 && (
                    <div className="px-6 pb-6">
                      <p className="text-gray-600 leading-relaxed">
                        İhtiyacınız olan reçetesiz ilaçların listesini WhatsApp
                        üzerinden göndermeniz yeterli. Adres bilgilerinizi aldıktan
                        sonra partner eczaneden temin edip 30 dakika içinde adresinize
                        teslim ediyoruz.
                      </p>
                    </div>
                  )}
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  {openFAQ === 1 && (
                    <div className="px-6 pb-6">
                      <p className="text-gray-600 leading-relaxed">
                        Hayır, biz sadece reçetesiz ilaçlar için kurye hizmeti
                        veriyoruz. Reçeteli ilaçlar için doğrudan eczaneyi ziyaret
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  {openFAQ === 5 && (
                    <div className="px-6 pb-6">
                      <p className="text-gray-600 leading-relaxed">
                        7/24 hizmet veriyoruz. Gece saatlerinde de acil durumlar için
                        ulaşabilirsiniz.
                      </p>
                    </div>
                  )}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              ...
              <div className="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Konya Merkez</p>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; 2025 Ecza Kapımda. Tüm hakları saklıdır.</p>
            </div>
          </div>
        </footer>
      </div>
